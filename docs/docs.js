  ...
  .factory('plunkGenerator', function($templateCache, $window) {
    ...
    return function(ngVersion, bsVersion, uibVersion, momentVersion, helpers, content) {
      ...
      $window.createPlunker.Plunker.create()
        .setDescription('http://murek85.github.io/angularjs-calendar/')
        ...
        .addNpmPackage('angularjs-calendar')
        ...
        .addNpmPackage('angularjs-calendar', {filename: 'dist/css/angularjs-calendar.min.css'})
